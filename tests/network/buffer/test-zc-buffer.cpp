...
NSFX_TEST_SUITE(ZcBuffer)
{
    ...
    NSFX_TEST_SUITE(Copy)/*{{{*/
    {
        ...
        NSFX_TEST_CASE(CopyAssign)
        {
            ...
            b0.AddAtEnd(100);
            // [600 s 100 zs 300 ze 100 e 200]
            nsfx::ZcBuffer b1(2000, 600);
            nsfx::ZcBuffer b2(b1); // Before change b1, use make a backup in b2.
            b1 = b0;
            //
            NSFX_TEST_EXPECT_EQ(b0.GetSize(), 500);
            NSFX_TEST_EXPECT_EQ(b0.GetInternalSize(), 200);
    ...
    NSFX_TEST_SUITE(AddAtStart)/*{{{*/
    {
        ...
        NSFX_TEST_CASE(AddZcBuffer)
        {
            ...
            nsfx::ZcBuffer b0(300, 300, 300);
            // s [300 s zs 300 ze e 300]
            b0.AddAtEnd(100);
            b0.AddAtStart(s);
    ...
    NSFX_TEST_SUITE(Fragment)/*{{{*/
    {
        NSFX_TEST_CASE(MakeFragment)
        {
            ...
            // Make fragment.
            nsfx::ZcBuffer f0 = b0.MakeFragment(0, 200);
            ...
            // Make fragment.
            nsfx::ZcBuffer f1 = b0.MakeFragment(300, 200);
            ...
            // Make fragment.
            nsfx::ZcBuffer f2 = b0.MakeFragment(200, 0);
            NSFX_TEST_EXPECT_EQ(f2.GetSize(), 0);
        }
    }/*}}}*/

    NSFX_TEST_SUITE(RealZcBuffer)/*{{{*/
    {
        NSFX_TEST_CASE(MakeRealBuffer)
        {
            ...
            // Make real buffer.
            nsfx::ZcBuffer b1 = b0.MakeRealBuffer();
            NSFX_TEST_EXPECT_EQ(b1.GetSize(), 500);
