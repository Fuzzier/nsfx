...
NSFX_TEST_SUITE(ZcBufferIterator)
{
    NSFX_TEST_CASE(Ctor)/*{{{*/
    {
...
NSFX_TEST_SUITE(ConstZcBufferIterator)
{
    NSFX_TEST_CASE(Ctor)/*{{{*/
    {
        nsfx::ZcBuffer b0(700, 300, 300);
        ...
        b0.AddAtEnd(100);
        // [600 s 100 zs 300 ze 100 e 200]
        nsfx::ConstZcBufferIterator it0;
        it0 = b0.cbegin();
    ...
    NSFX_TEST_CASE(CopyCtor)/*{{{*/
    {
        ...
        nsfx::ConstZcBufferIterator it1(it0);

        NSFX_TEST_EXPECT_EQ(it1.GetStart(),  b0.GetStart());
        NSFX_TEST_EXPECT_EQ(it1.GetEnd(),    b0.GetEnd());
        NSFX_TEST_EXPECT_EQ(it1.GetCursor(), b0.GetStart());

        nsfx::ConstZcBufferIterator it2(b0.begin());
