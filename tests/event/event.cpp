...
NSFX_TEST_SUITE(Event)
{
    ...
    NSFX_DEFINE_CLASS_UUID(Iv0, 0x67CB03B4, 0x5B1C, 0x4401, 0xB418C6758383839ELL);
    NSFX_DEFINE_EVENT_SINK_INTERFACE(Iv1, ( void(int) ));
    NSFX_DEFINE_CLASS_UUID(Iv1, 0xC2B34B86, 0xA3F2, 0x45FD, 0x9654CD79A928B1A6LL);
    NSFX_DEFINE_EVENT_SINK_INTERFACE(Iv2, ( void(int, double) ));
    NSFX_DEFINE_CLASS_UUID(Iv2, 0x1F02B3BA, 0x7567, 0x423B, 0xBDD995AE1F87D30ALL);
    NSFX_DEFINE_EVENT_SINK_INTERFACE(Iv3, ( void(int, double, std::string) ));
    NSFX_DEFINE_CLASS_UUID(Iv3, 0x5193AFBA, 0x12C5, 0x49ED, 0xAF9C11D00334EC44LL);

    NSFX_DEFINE_EVENT_SINK_INTERFACE(Ir0, ( float(void) ));
    NSFX_DEFINE_CLASS_UUID(Ir0, 0x5E008399, 0x8D24, 0x4229, 0x84135C57A065AE32LL);
    NSFX_DEFINE_EVENT_SINK_INTERFACE(Ir1, ( float(int) ));
    NSFX_DEFINE_CLASS_UUID(Ir1, 0xA9E86104, 0x16A0, 0x4CA4, 0xA4B7380190520F5FLL);
    NSFX_DEFINE_EVENT_SINK_INTERFACE(Ir2, ( float(int, double) ));
    NSFX_DEFINE_CLASS_UUID(Ir2, 0x1D34DD48, 0x566D, 0x4645, 0x9198BB055E281AF9LL);
    NSFX_DEFINE_EVENT_SINK_INTERFACE(Ir3, ( float(int, double, std::string) ));
    NSFX_DEFINE_CLASS_UUID(Ir3, 0x27951022, 0x2516, 0x43F0, 0xAC57106233362CB0LL);
    ...
    NSFX_DEFINE_CLASS_UUID(Ev0, 0x7F1AE701, 0xAA48, 0x469D, 0x922576E4CB76F385LL);
    NSFX_DEFINE_CLASS_UUID(Ev1, 0x21416D80, 0xF7B4, 0x4302, 0x8E8EC3DE38DED5B9LL);
    NSFX_DEFINE_CLASS_UUID(Ev2, 0x8C4B03E4, 0x8137, 0x4DC1, 0x9AEC76EDABFE09BCLL);
    NSFX_DEFINE_CLASS_UUID(Ev3, 0x2C4F3609, 0x6C25, 0x4B48, 0x8D559A1013F9380CLL);

    NSFX_DEFINE_CLASS_UUID(Er0, 0xB9255B19, 0x5C91, 0x47A0, 0xBA0A8D9B920504F8LL);
    NSFX_DEFINE_CLASS_UUID(Er1, 0x7E4FD966, 0x57E7, 0x4109, 0xB06889D28DA8B5EDLL);
    NSFX_DEFINE_CLASS_UUID(Er2, 0x30B62CAA, 0x5BBF, 0x413C, 0xA7E3FE5CFCFF5A13LL);
    NSFX_DEFINE_CLASS_UUID(Er3, 0x1E5947E6, 0x8B0B, 0x43A3, 0xA210DD62A76017E5LL);
