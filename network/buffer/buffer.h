...
/**
 * @ingroup Network
 * @brief A resizable buffer that supports copy-on-resize.
 *
 ...
 */
template<>
class BasicBuffer</*readOnly*/false, /*copyOnResize*/true, /*zeroArea*/false>
{
public:
    typedef BasicBuffer<false, true, false>              Buffer;
...
private:
     ...
     * @internal
     */
    BasicBuffer(BufferStorage* storage, size_t start, size_t end) BOOST_NOEXCEPT;
...
public:
     ...
     */
    BasicBuffer(const Buffer& rhs) BOOST_NOEXCEPT;
...
public:
     ...
     * @brief Move a buffer.
     */
    BasicBuffer(Buffer&& rhs) BOOST_NOEXCEPT;
...
////////////////////////////////////////////////////////////////////////////////
// Typedef.
typedef BasicBuffer</*readOnly*/false, /*copyOnResize*/true, /*zeroArea*/false>
        Buffer;


////////////////////////////////////////////////////////////////////////////////
// Buffer.
inline Buffer::BasicBuffer(void) BOOST_NOEXCEPT :
    storage_(nullptr),
    start_(0),
    end_(0)
{
...
inline Buffer::BasicBuffer(size_t capacity) :
...
inline Buffer::BasicBuffer(BufferStorage* storage, size_t start, size_t end) BOOST_NOEXCEPT :
    storage_(storage),
    start_(start),
    end_(end)
{
...
template<bool readOnly, bool copyOnResize, bool zeroArea>
inline Buffer::BasicBuffer(const BasicBuffer<readOnly, copyOnResize, zeroArea>& rhs) :
...
inline Buffer::BasicBuffer(const Buffer& rhs) BOOST_NOEXCEPT :
...
inline Buffer::BasicBuffer(Buffer&& rhs) BOOST_NOEXCEPT :
    storage_(rhs.storage_),
    start_(rhs.start_),
    end_(rhs.end_)
{
...
inline const Buffer::BufferStorage*
Buffer::GetStorage(void) const BOOST_NOEXCEPT
{
    return storage_;
}
