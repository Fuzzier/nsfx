...
/**
 * @ingroup Network
 * @brief An zero-compressed, read-only buffer that supports copy-on-write.
 *
 * # Structure
 ...
 */
template<>
class BasicBuffer</*readOnly*/true, /*copyOnWrite*/true, /*zeroArea*/true>
{
public:
    typedef BasicBuffer<true, true, true>   ConstZcBuffer;
...
public:
     ...
     */
    BasicBuffer(const ZcBuffer& buffer) BOOST_NOEXCEPT;
...
public:
     ...
     */
    BasicBuffer(const ConstZcBuffer& rhs) BOOST_NOEXCEPT;
...
public:
     ...
     * @brief Move a buffer.
     */
    BasicBuffer(ConstZcBuffer&& rhs) BOOST_NOEXCEPT;
...
////////////////////////////////////////////////////////////////////////////////
// Typedef.
typedef BasicBuffer</*readOnly*/true, /*copyOnWrite*/true, /*zeroArea*/true>
        ConstZcBuffer;


////////////////////////////////////////////////////////////////////////////////
// ConstZcBuffer.
inline ConstZcBuffer::BasicBuffer(const ZcBuffer& buffer) BOOST_NOEXCEPT :
    buffer_(buffer)
{
}

inline ConstZcBuffer::BasicBuffer(const ConstZcBuffer& rhs) BOOST_NOEXCEPT :
    buffer_(rhs.buffer_)
{
}
...
inline ConstZcBuffer::BasicBuffer(ConstZcBuffer&& rhs) BOOST_NOEXCEPT :
    buffer_(rhs.buffer_)
{
}
...
inline const ConstZcBuffer::BufferStorage*
ConstZcBuffer::GetStorage(void) const BOOST_NOEXCEPT
{
