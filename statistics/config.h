 ...
 *   present the data.
 *   The interface between the source and sink is called a <i>probe</i>.
 ...
 *    a name.
 *
 *    A probe provides \c IProbeEvent interface.
 *    A sink implements \c IProbeEventSink, and connects it to the event to
 *    collect the reported data.
 *
 *    For simplicity and unification, the type of the reported data is \c double.
 *
 * ## Source
 *    For generality, a source <b>shall</b> report <i>raw data</i>.
 *
 ...
 *    These sinks are called <i>statistics</i>.
 *
